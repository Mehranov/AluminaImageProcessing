            ...
            case 1 % peak find - using the local maxima approach - 1 pixel resolution
                ...
                for j=1:length(y)
                   if (d(x(j),y(j))>=d(x(j)-1,y(j)-1 )) &&...
                            ...
                            (d(x(j),y(j))>d(x(j)+1,y(j))) && ...
                            (d(x(j),y(j))>=d(x(j)+1,y(j)+1)) ;
%                             (d(x(j),y(j))>=d(x(j)-2,y(j)-2 )) &&...
%                             (d(x(j),y(j))>d(x(j)-2,y(j)-1)) &&...
%                             (d(x(j),y(j))>=d(x(j)-2,y(j))) &&...
%                             (d(x(j),y(j))>d(x(j)-2,y(j)+1)) && ...
%                             (d(x(j),y(j))>d(x(j)-2,y(j)+2)) && ...
%                             (d(x(j),y(j))>=d(x(j)-1,y(j)-2)) && ...
%                             (d(x(j),y(j))>d(x(j)-1,y(j)+2)) && ...
...
%                             (d(x(j),y(j))>d(x(j)+2,y(j)+1)) && ...
%                             (d(x(j),y(j))>d(x(j)+2,y(j)+2))&&...
%                             (d(x(j),y(j))>d(x(j)-3,y(j)-3))&&...
%                             (d(x(j),y(j))>d(x(j)-3,y(j)-2))&&...
%                             (d(x(j),y(j))>d(x(j)-3,y(j)-1))&&...
%                             (d(x(j),y(j))>d(x(j)-3,y(j)))&&...
%                             (d(x(j),y(j))>d(x(j)-3,y(j)+1))&&...
%                             (d(x(j),y(j))>d(x(j)-3,y(j)+2))&&...
%                             (d(x(j),y(j))>d(x(j)-3,y(j)+3))&&...
%                             (d(x(j),y(j))>d(x(j)-2,y(j)-3))&&...
%                             (d(x(j),y(j))>d(x(j)-2,y(j)+3))&&...
%                             (d(x(j),y(j))>d(x(j)-1,y(j)-3))&&...
%                             (d(x(j),y(j))>d(x(j)-1,y(j)+3))&&...
%                             (d(x(j),y(j))>d(x(j),y(j)-3))&&...
%                             (d(x(j),y(j))>d(x(j),y(j)+3))&&...
%                             (d(x(j),y(j))>d(x(j)+1,y(j)-3))&&...
%                             (d(x(j),y(j))>d(x(j)+1,y(j)+3))&&...
%                             (d(x(j),y(j))>d(x(j)+2,y(j)-3))&&...
...
%                             (d(x(j),y(j))>d(x(j)+3,y(j)+3));
                ...
                case 2 % peak find - using the local maxima approach - 1 pixel resolution
                ...
                case 3 % peak find - using the local maxima approach - 1 pixel resolution
                ...
                case 4 % peak find - using the local maxima approach - 1 pixel resolution
                ...
                for j=1:length(y)
                   if (d(x(j),y(j))>=d(x(j)-1,y(j)-1 )) &&...
                            ...
                            (d(x(j),y(j))>d(x(j)+3,y(j)+2))&&...
                            (d(x(j),y(j))>d(x(j)+3,y(j)+3))&&...
                            (d(x(j),y(j))>d(x(j)-4,y(j)-4))&&...
                            (d(x(j),y(j))>d(x(j)-4,y(j)-3))&&...
                            (d(x(j),y(j))>d(x(j)-4,y(j)-2))&&...
                            (d(x(j),y(j))>d(x(j)-4,y(j)-1))&&...
                            (d(x(j),y(j))>d(x(j)-4,y(j)))&&...
                            (d(x(j),y(j))>d(x(j)-4,y(j)+1))&&...
                            (d(x(j),y(j))>d(x(j)-4,y(j)+2))&&...
                            (d(x(j),y(j))>d(x(j)-4,y(j)+3))&&...
                            (d(x(j),y(j))>d(x(j)-4,y(j)+4))&&...
                            (d(x(j),y(j))>d(x(j)-3,y(j)-4))&&...
                            (d(x(j),y(j))>d(x(j)-3,y(j)+4))&&...
                            (d(x(j),y(j))>d(x(j)-2,y(j)-4))&&...
                            (d(x(j),y(j))>d(x(j)-2,y(j)+4))&&...
                            (d(x(j),y(j))>d(x(j)-1,y(j)-4))&&...
                            (d(x(j),y(j))>d(x(j)-1,y(j)+4))&&...
                            (d(x(j),y(j))>d(x(j),y(j)-4))&&...
                            (d(x(j),y(j))>d(x(j),y(j)+4))&&...
                            (d(x(j),y(j))>d(x(j)+1,y(j)-4))&&...
                            (d(x(j),y(j))>d(x(j)+1,y(j)+4))&&...
                            (d(x(j),y(j))>d(x(j)+2,y(j)-4))&&...
            ...
            case 5 % find weighted centroids of processed image,  sub-pixel resolution.
